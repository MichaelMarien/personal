...
Single-file web apps. No build step, no framework — just open `index.html`.
...
Open the URL in Safari → **Share** → **Add to Home Screen** → launches full-screen with the app icon.

## Projects

### `princess/` — Prinsessen Spelletjes 👑
Four mini-games (memory, dress-up, find-the-item, battleship). Dutch TTS, generated SFX, drag-and-drop, wake lock. See `princess/docs/` for design spec and implementation plan.
